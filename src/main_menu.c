...
static const struct MenuAction sMenuActions_Gender[] = {
    {COMPOUND_STRING("CLOWN"), {NULL}},
    {COMPOUND_STRING("BADDIE"), {NULL}}
};
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_MURKROW);
...
{
    return CreateMonPicSprite_Affine(SPECIES_MURKROW, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
