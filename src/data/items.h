...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = (I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 500 : 5000),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
...
// Choice Items
    ...
    {
        .name = _("Choice Band"),
        .price = (I_PRICE >= GEN_9) ? 5000 : ((I_PRICE >= GEN_7) ? 4000 : 1),
    ...
    [ITEM_CHOICE_SCARF] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 5000 : ((I_PRICE >= GEN_7) ? 5000 : 1),
