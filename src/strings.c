...
const u8 gText_ThisIsAPokemon[] = _("Just look at this little dude.{PAUSE 96}\p");
...
const u8 gText_ShopQuit[] = _("OH HELL NAH");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a little extra sauce, too.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("I'll throw in {STR_VAR_1} of my premium product, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggCantBattle[] = _("An EGG can't battle!, are you dumb?{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnNeedsToReplaceMove[] = _("{STR_VAR_1} wants to learn the\nmove {STR_VAR_2}.\pHowever, {STR_VAR_1} already\nknows four way better moves.\pShould a move be deleted and\nreplaced with {STR_VAR_2}?");
const u8 gText_StopLearningMove2[] = _("Finally going to stop trying to teach\n{STR_VAR_2}?");
...
const u8 gText_PkmnWokeUp2[] = _("{STR_VAR_1} succumbed to the\nwoke mind virus.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PPWasRestored[] = _("PP was restored\n... ayo...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnSnappedOutOfConfusion[] = _("{STR_VAR_1} locked in\nand snapped out of its\nconfusion.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverInfatuation[] = _("{STR_VAR_1} got the ick and\nlost itsinfatuation.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NothingToCut[] = _("Are you retarded? :sob: please kys.");
const u8 gText_CantSurfHere[] = _("Are you retarded? :sob: please kys.");
const u8 gText_AlreadySurfing[] = _("Are you retarded? :sob: please kys..");
...
const u8 gText_WontEatAnymore[] = _("Bro please stop feeding him LOL");
...
const u8 gText_AlolaStarters[] = _("ALOLA");
...
//names
const u8 gText_SideQuestName_1[] = _("Lonely Mother");
const u8 gText_SideQuestName_2[] = _("Oldale's Lost Children");
...
const u8 gText_SideQuestDesc_2[] = _("Help find Oldale Kids");
...
const u8 gText_SideQuestDoneDesc_1[] = _("All in balance, as it should be.");
const u8 gText_SideQuestDoneDesc_2[] = _("Kids are back home yay.");
...
//map
const u8 gText_SideQuestMap1[] = _("New York City");
const u8 gText_SideQuestMap2[] = _("Oldale Town");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("RAAAH QUST 1 ");
...
const u8 gText_SubQuest2_Name1[] = _("RAAAH QUEST 2");
...
const u8 gText_SubQuest1_Desc1[] = _("SUB QUEST 1");
...
const u8 gText_SubQuest2_Desc1[] = _("2ND SUBQUEST 1");
