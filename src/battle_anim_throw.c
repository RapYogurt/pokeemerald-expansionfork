...
static const struct CompressedSpriteSheet sBallParticleSpriteSheets[] =
{
    ...
    [BALL_SNAG]     = {gBattleAnimSpriteGfx_Particles,      0x100, TAG_PARTICLES_BEASTBALL}, // ME AS HELL
...
static const struct SpritePalette sBallParticlePalettes[] =
{
    ...
    [BALL_SNAG]   = {gBattleAnimSpritePal_CircleImpact,     TAG_PARTICLES_BEASTBALL}, // ME AS HELL
...
static const TaskFunc sBallParticleAnimationFuncs[POKEBALL_COUNT] =
{
    ...
    [BALL_SNAG]    = UltraBallOpenParticleAnimation,
